...
const defaultServices: ServiceData[] = [
  ...
  { id: "6", icon: "Phone", title: "Консультация", short_desc: "Экспертная помощь по запросу", description: "Индивидуальные консультации по вопросам учёта, управления и оптимизации ресторанного бизнеса.", features: ["Разбор текущей ситуации", "Рекомендации по оптимизации", "Ответы на вопросы по учёту", "План действий"], color: "from-[#c04880] to-[#e05a9c]", sort_order: 6 },
];
