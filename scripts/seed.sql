...
('Phone', 'Консультация', 'Экспертная помощь по запросу', 'Индивидуальные консультации по вопросам учёта, управления и оптимизации ресторанного бизнеса.', ARRAY['Разбор текущей ситуации', 'Рекомендации по оптимизации', 'Ответы на вопросы по учёту', 'План действий'], 'from-[#c04880] to-[#e05a9c]', 6);
